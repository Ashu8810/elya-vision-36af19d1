    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <a
            href="#"
            className="group flex items-center justify-center w-40 h-16 rounded-full bg-white text-gray-900 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
          >
            <svg
