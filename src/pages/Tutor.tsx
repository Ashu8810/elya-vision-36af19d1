...
const suggestedPrompts = [
  ...
  { icon: Brain, text: "Help me understand calculus derivatives" },
  { icon: Lightbulb, text: "What are the key concepts of machine learning?" },
  { icon: Sparkles, text: "Create a study plan for my exams" },
];

const mockSessions: ChatSession[] = [
  { id: "1", title: "Quantum Physics Basics", lastMessage: "The wave-particle duality...", timestamp: new Date() },
  { id: "2", title: "Calculus Help", lastMessage: "To find the derivative...", timestamp: new Date(Date.now() - 86400000) },
  { id: "3", title: "Essay Writing Tips", lastMessage: "Structure your argument...", timestamp: new Date(Date.now() - 172800000) },
];
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        role: "assistant",
        content: "I understand you're asking about this topic. Let me break it down for you in a way that's easy to understand...\n\nThis is a simulated response. In a real implementation, this would connect to an AI backend to provide intelligent tutoring assistance.",
        timestamp: new Date(),
      };
      ...
      >
        <div className="p-4 border-b border-border/50">
          <Link to="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="font-bold text-lg">StudyAI Tutor</span>
          </Link>
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                ...
                <p className="text-muted-foreground mb-8 max-w-md">
                  I'm your personal AI tutor. Ask me anything about any subject, and I'll help you understand it better.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-lg">
                  {suggestedPrompts.map((prompt, index) => (
                    <button
                      ...
                      className="flex items-center gap-3 p-4 rounded-xl border border-border/50 bg-card/50 hover:bg-accent/50 hover:border-primary/30 transition-all text-left group"
                    >
